  ...
  return (
    <div className="p-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-200 dark:border-gray-700 cursor-pointer hover:shadow-md transition-shadow">
          ...
          <p className="text-3xl font-bold text-gray-900 dark:text-white mb-1">$172.93</p>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-200 dark:border-gray-700 cursor-pointer hover:shadow-md transition-shadow">
          ...
          <p className="text-3xl font-bold text-gray-900 dark:text-white mb-1">$481.00</p>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-200 dark:border-gray-700 cursor-pointer hover:shadow-md transition-shadow">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h3 className="font-semibold dark:text-white">Reporte Anual</h3>
              <p className="text-sm text-gray-500">2025</p>
            </div>
          </div>
          <p className="text-3xl font-bold text-gray-900 dark:text-white mb-1">$1,896.00</p>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-200 dark:border-gray-700 mb-6">
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-xl font-semibold dark:text-white">Comparación Mes a Mes</h2>
          <select className="px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg text-sm bg-white dark:bg-gray-700 dark:text-gray-200 focus:outline-none focus:ring-2 focus:ring-emerald-500">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-gradient-to-br from-emerald-50 to-emerald-100 dark:from-slate-800 dark:to-slate-700 rounded-xl p-6 border border-emerald-200 dark:border-slate-600">
          <h3 className="font-semibold text-emerald-900 dark:text-emerald-200 mb-2">Exportar como PDF</h3>
          <p className="text-emerald-700 dark:text-emerald-100 text-sm mb-4">
        ...
        <div className="bg-gradient-to-br from-blue-50 to-blue-100 dark:from-slate-800 dark:to-slate-700 rounded-xl p-6 border border-blue-200 dark:border-slate-600">
          <h3 className="font-semibold text-blue-900 dark:text-blue-200 mb-2">Exportar como Excel</h3>
          <p className="text-blue-700 dark:text-blue-100 text-sm mb-4">
