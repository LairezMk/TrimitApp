...
export default function Trends() {
  ...
  return (
    <div className="p-8">
      <div className="mb-8">
        <h1 className="text-3xl mb-2">Tendencias y Análisis</h1>
      ...
      <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200 mb-8">
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-xl font-semibold">Evolución de Gastos</h2>
      ...
      {/* Insights */}
      <div className="mb-8">
        <h2 className="text-xl font-semibold mb-6">Insights del Mes</h2>
      ...
      <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
        <h2 className="text-xl font-semibold mb-6">Número de Suscripciones</h2>
      ...
      <div className="mt-8 bg-gradient-to-r from-purple-50 to-pink-50 rounded-xl p-6 border border-purple-200">
        <div className="flex items-start gap-4">
          ...
          <div>
            <h3 className="font-semibold text-purple-900 mb-2">Predicción para Marzo</h3>
